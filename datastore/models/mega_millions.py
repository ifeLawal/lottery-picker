...
class DataAccessObject:
    ...
    regular_numbers = Table('regular_numbers', metadata,
        Column("id",Integer(), primary_key=True),
        ...
        Column("day_of_the_week_id",Integer(), ForeignKey("days_of_the_week.id"), nullable=False),
        Column("year_id",Integer(), ForeignKey("years.id"), nullable=False),
        Column("day_id",Integer(), ForeignKey("days.id"), nullable=False),
    )
    
    mega_ball_numbers = Table('mega_ball_numbers', metadata,
        Column("id",Integer, primary_key=True),
        Column("number",Integer(), nullable=False),
        Column("month_id",Integer(), ForeignKey("months.id"), nullable=False),
        Column("week_id",Integer(), ForeignKey("weeks.id"), nullable=False),
    ...
    months = Table('months', metadata, 
        Column("id",Integer(), primary_key=True),
        Column("month",String(128), nullable=False)
    )
    
    days_of_the_week = Table('days_of_the_week', metadata,
        Column("id",Integer(), primary_key=True),
        Column("day_of_the_week",String(128), nullable=False),
    )
    
    weeks = Table('weeks', metadata,
        Column("id",Integer(), primary_key=True),
        Column("week",Integer(), nullable=False)
    )
    
    quarters = Table('quarters', metadata,
        Column("id",Integer(), primary_key=True),
    ...
    pure_random_ticket_attempts = Table('pure_random_ticket_attempts', metadata,
        Column("id",Integer, primary_key=True),
        Column("draw_date",String(128), nullable=False),
        Column("first_number",Integer()),
        Column("second_number",Integer()),
    ...
    weighted_ticket_attempts = Table('weighted_ticket_attempts', metadata,
        Column("id",Integer, primary_key=True),
        Column("draw_date",String(128), nullable=False),
        Column("first_number",Integer()),
        Column("second_number",Integer()),
    ...
    connected_number_occurrences = Table('connected_number_occurrences', metadata,
     Column("id",Integer(), primary_key=True),
...
def prep_db() -> None:
    ...
    dao.connection.execute(ins, number=23, month_id=3, week_id=4, quarter_id=1, day_of_the_week_id=2, year_id=2, day_id=2)
