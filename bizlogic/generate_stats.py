...
def set_connected_number_occurrences() -> None:
    ...
    with dao.session() as sess:
        ...
        for id in sess.query(dao.winners.c.id).distinct():
            ...
            add_occurrence_of_other_lotto_numbers(main_number=first_number, other_number_1=second_number, other_number_2=third_number, other_number_3=fourth_number, other_number_4=fifth_number, sess=sess)
            
            add_occurrence_of_other_lotto_numbers(main_number=second_number,other_number_1=first_number, other_number_2=third_number, other_number_3=fourth_number, other_number_4=fifth_number, sess=sess)
            
            add_occurrence_of_other_lotto_numbers(main_number=third_number,other_number_1=first_number, other_number_2=second_number, other_number_3=fourth_number, other_number_4=fifth_number, sess=sess)
            
            add_occurrence_of_other_lotto_numbers(main_number=fourth_number,other_number_1=first_number, other_number_2=second_number, other_number_3=third_number, other_number_4=fifth_number, sess=sess)
...
def update_recent_connected_number_occurrences() -> None:
    with dao.session()as sess:
        ...
        for winner in last_two_added_winners:
            ...
            add_occurrence_of_other_lotto_numbers(main_number=first_number, other_number_1=second_number, other_number_2= third_number, other_number_3=fourth_number, other_number_4=fifth_number)
        

def add_occurrence_of_other_lotto_numbers(main_number, other_number_1, other_number_2, other_number_3, other_number_4, sess):
    if main_number <= 70 and other_number_1 <= 70 and other_number_2 <= 70 and other_number_3 <= 70 and other_number_4 <= 70:
